...
export function RecommendationDialog({
  ...
  const items =
    tab === 'canonical' ? currentRecs?.canonical : currentRecs?.spicy
          ...
          <>
            ...
            <div className="flex flex-col w-full border-b px-3 py-2">
              ...
              <span className="text-[0.6rem] text-gray-400 truncate">
                {tab === 'canonical'
                  ? t('recommendationDialog.mostFrequent', {
                      genre: GENRE_DISPLAY[selectedGenre],
                    })
                  : t('recommendationDialog.lessCommon', {
                      genre: GENRE_DISPLAY[selectedGenre],
                    })}
              </span>
            </div>
